...
describe('Hooks Function testing',()=>{
    ...
    it('ShortArray',()=>{
        ...
        expect(ShortArray(test, null, 'name')).toEqual([{name:'a'},{name:'b'},{name:'c'}])
        ...
        expect(ShortArray(test2,null)).toEqual(['a','b','c'])
        ...
        expect(ShortArray(test3, null, 'name')).toEqual([{name:1},{name:2},{name:3}])
